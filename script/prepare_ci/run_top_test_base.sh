...
if [ -n "$k" ]; then
  ...
  list=("pdm_t_dcube_nodal_gen" "pdm_t_part_to_block_geom" "pdm_t_closest_points" "pdm_t_dist" "pdm_t_dist_strip" "pdm_t_gnum" "pdm_t_global_mean" "pdm_t_gnum_location" "pdm_t_dmesh_nodal_to_dmesh" "pdm_t_knn_cube")
  n_suite=0
  for item in ${list[*]}; do
    echo $item;
