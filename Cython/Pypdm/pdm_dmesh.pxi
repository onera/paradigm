...
cdef class DistributedMesh:
  ...
  @staticmethod
  cdef from_ptr(PDM_dmesh_t* ptr):
    # Take ownership on structure
    cdef DistributedMesh obj = DistributedMesh.__new__(DistributedMesh)
    obj._dm = ptr
    return obj
  ...
  def dmesh_vtx_coord_set(self,
    ...
    PDM_dmesh_vtx_coord_set(self._dm, <double *> dvtx_coord.data, PDM_OWNERSHIP_USER)
  def dmesh_vtx_coord_get(self):
    dn_vtx = PDM_dmesh_dn_entity_get(self._dm, PDM_MESH_ENTITY_VTX)
    cdef double* dvtx_coord = NULL
    PDM_dmesh_vtx_coord_get(self._dm, &dvtx_coord, PDM_OWNERSHIP_USER)
  ...
  def dmesh_connectivity_get(self, PDM_connectivity_type_t connectivity_type):
    ...
    # ************************************************************************
    dn_entity = PDM_dmesh_connectivity_get(self._dm,
                                          connectivity_type,
                                          &connect,
                                          &connect_idx,
                                          PDM_OWNERSHIP_USER)
  ...
  def dmesh_connectivity_set(self, PDM_connectivity_type_t connectivity_type,
    ...
    PDM_dmesh_connectivity_set(self._dm,
                              connectivity_type,
                              _connect,
                              _connect_idx,
                              PDM_OWNERSHIP_USER)
  ...
  def dmesh_distrib_get(self, PDM_mesh_entities_t entity_type):
    ...
    cdef int size = PDM_dmesh_distrib_get(self._dm, entity_type, &distrib)
  ...
  def dmesh_bound_get(self, PDM_bound_type_t bound_type):
    ...
    cdef int           n_bnd
    # ************************************************************************
    n_bnd = PDM_dmesh_bound_get(self._dm,
                                bound_type,
                                &connect,
                                &connect_idx,
                                PDM_OWNERSHIP_USER)
  ...
  def dmesh_bound_set(self, PDM_bound_type_t bound_type,
    ...
    """
    """
    cdef int n_bnd = connect_idx.shape[0]-1
    PDM_dmesh_bound_set(self._dm,
                        bound_type,
                        n_bnd,
