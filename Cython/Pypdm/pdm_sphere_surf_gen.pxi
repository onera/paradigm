...
def sphere_surf_icosphere_gen_nodal(MPI.Comm       comm,
  ...
  :note: The output mesh is *block-distributed* in the form of a :py:class:`DistributedMeshNodal` object
  ...
  Returns:
    Distributed nodal icosphere mesh (:py:class:`DistributedMeshNodal`)
  """
