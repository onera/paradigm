cdef extern from "pdm_part_comm_graph.h":
  ...
  PDM_part_comm_graph_t* PDM_part_comm_graph_create(
    int               n_part,
    int              *pn_entity_graph,
    int             **pentity_graph,
  ...
  PDM_part_comm_graph_t* PDM_part_comm_graph_with_nuplet_create(
    int               n_part,
    int              *pn_entity_graph,
    int             **pentity_graph,
  ...
  # # :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  int* PDM_part_comm_graph_owner_get(
    PDM_part_comm_graph_t *pcg,
    int                    i_part);

  # :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  int PDM_part_comm_graph_entity_graph_get(
    PDM_part_comm_graph_t  *pcg,
    int                     i_part,
    int                   **entity_graph,
    PDM_ownership_t         ownership);
  ...
  # :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  int PDM_part_comm_graph_entity_nuplet_get(
    PDM_part_comm_graph_t  *pcg,
    int                     i_part,
    int                   **entity_nuplet,
    PDM_ownership_t         ownership);
  ...
  # # :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  PDM_part_comm_graph_t* PDM_part_comm_graph_free(
    PDM_part_comm_graph_t* pcg);
...
cdef class PartCommGraph:
  ...
  def __init__(self,
              MPI.Comm    comm,
              int         n_part,
              list pn_entity_graph, # int *
              list pentity_graph,   #int **
               ):
    """
    ...
    self.pcg =  PDM_part_comm_graph_create(
             self._n_part,
  ...
  def with_nuplet_create(self, MPI.Comm comm,
    int  n_part,
    list pn_entity_graph, #int*
    list pentity_graph, #int**
    int  nuplet_size,
    list pentity_nuplet, #int**
    bint is_signed):
    ...
    self.pcg = PDM_part_comm_graph_with_nuplet_create(
                 self._n_part,
...
# ------------------------------------------------------------------------
# def with_nuplet_create(PyPartCommGraph pypcg, MPI.Comm comm,
#     list pn_entity_graph, #int*
#     list pentity_graph, #int**
#     int               nuplet_size,
#     list pentity_nuplet, #int**
...
#   # FIXME: est-ce que le trick sur comm -> PDMC est obligatoire ?
#   pypcg.pcg = PDM_part_comm_graph_with_nuplet_create(
#                _n_part,
#                pn_entity_graph,
#                pentity_graph,
#                PDM_OWNERSHIP_USER,
#                nuplet_size,
#                pentity_nuplet,
#                PDM_OWNERSHIP_USER, # FIXME: au pif
#   <PDM_bool_t> is_signed,
#                PDMC)
...
def entity_nuplet_get(PyPartCommGraph pypcg, int i_part):
  ...
  n_entity = PDM_part_comm_graph_entity_nuplet_get(
     pypcg.pcg,
     i_part,
    &entity_nuplet,
     PDM_OWNERSHIP_USER)
