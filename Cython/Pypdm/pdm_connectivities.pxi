...
# ------------------------------------------------------------------------
def decompose_std_elmt_faces(            int                               elt_type,
                             NPY.ndarray[npy_pdm_gnum_t, mode='c', ndim=1] elt_vtx):
    '''
    Wrapping function if `PDM_std_decomposes_faces` function.
    For now only TETRA_4 wrapping is done, but interface can be updated to manage other std elements.
    '''
    # > Define n_vtx and n_face for each std elements
    elt_type_to_n_vtx = {1:2, # BAR_2
                         2:3, # TRI_3
                         3:4, # QUAD_4
                         5:4, # TETRA_4
                         6:5, # PYRAMID_5
                         }
    elt_type_to_n_face = {1:0, # BAR_2
                          2:1, # TRI_3
                          3:1, # QUAD_4
                          5:4, # TETRA_4
                          6:5, # PYRAMID_5
                         }
    elt_type_to_nsum_vtx_face = {1:0, # BAR_2
                                 2:3, # TRI_3
                                 3:4, # QUAD_4
                                 5:12, # TETRA_4
                                 6:15, # PYRAMID_5
    ...
    PDM_std_decomposes_faces(<PDM_Mesh_nodal_elt_t> elt_type,
                                                    order,
                                                   _parent_node,
                                                    n_elt,
                                                  &_n_elt_current,
