...
)
{
  ...
  if (direction == PDM_EXCHANGE_DIRECTION_SEND) {
    ...
    PDM_error("Error PDM_part_comm_graph_exch_one_way_raw_init not yet implemented with direction = %i\n", direction);
  }
...
)
{
  ...
  if (direction == PDM_EXCHANGE_DIRECTION_SEND) {
    ...
    PDM_error("Error PDM_part_comm_graph_iexch_one_way_raw not yet implemented with direction = %i\n", direction);
  }
