...
module pdm_part_mesh_nodal
  ...
  interface
    ...
    function PDM_part_mesh_nodal_n_vtx_get_c(pmn, i_part) result(n_vtx) &
    ...
    end function PDM_part_mesh_nodal_n_vtx_get_c


    function PDM_part_mesh_nodal_section_elt_type_get_c(pmn, i_section) result(elt_t) &
    ...
    end function PDM_part_mesh_nodal_section_elt_type_get_c
    ...
    function PDM_part_mesh_nodal_n_section_in_geom_kind_get_c(pmn, geom_kind) result(n_section) &
    ...
    end function PDM_part_mesh_nodal_n_section_in_geom_kind_get_c


    function PDM_part_mesh_nodal_section_n_elt_get_c(pmn, i_section, i_part) result(n_elt) &
    ...
    end function PDM_part_mesh_nodal_section_n_elt_get_c
  ...
  subroutine PDM_part_mesh_nodal_create(mesh,           &
                                        mesh_dimension, &
                                        n_part,         &
                                        f_comm)
    ...
    interface
      function PDM_part_mesh_nodal_create_c (mesh_dimension, n_part, c_comm) result(mesh) &
        bind(c, name='PDM_part_mesh_nodal_create')
        use iso_c_binding
        implicit none
    ...
    mesh = PDM_part_mesh_nodal_create_c(mesh_dimension, &
                                        n_part,         &
                                        c_comm)
  ...
  subroutine PDM_part_mesh_nodal_coord_set(mesh,    &
                                           id_part, &
                                           n_vtx,   &
                                           coords,  &
                                           owner)
    ...
    call PDM_part_mesh_nodal_coord_set_c(mesh,     &
                                         id_part,  &
                                         n_vtx,    &
                                         c_coords, &
                                         owner)
  ...
  subroutine PDM_part_mesh_nodal_vtx_gnum_set(mesh,    &
                                              id_part, &
                                              numabs,  &
                                              owner)
    ...
    call PDM_part_mesh_nodal_vtx_gnum_set_c(mesh,     &
                                            id_part,  &
                                            c_numabs, &
                                            owner)
  ...
  function PDM_part_mesh_nodal_section_add(pmn,      &
    ...
    interface
      function PDM_part_mesh_nodal_section_add_c(pmn, elt_type) result (id_section) &
      ...
      end function PDM_part_mesh_nodal_section_add_c
    end interface

    id_section = PDM_part_mesh_nodal_section_add_c(pmn, elt_type)

  end function PDM_part_mesh_nodal_section_add


  subroutine PDM_part_mesh_nodal_section_std_set(pmn,                 &
                                                 i_section,           &
                                                 i_part,              &
                                                 n_elts,              &
                                                 connec,              &
    ...
    interface
      subroutine PDM_part_mesh_nodal_section_std_set_c(pmn,                 &
                                                       i_section,           &
                                                       i_part,              &
                                                       n_elts,              &
                                                       connec,              &
        ...
        type (c_ptr),   value :: numabs
        type (c_ptr),   value :: parent_num
        type (c_ptr),   value :: parent_entity_g_num
        integer(c_int), value :: ownership
      end subroutine PDM_part_mesh_nodal_section_std_set_c
    end interface
    ...
    call PDM_part_mesh_nodal_section_std_set_c(pmn,                   &
                                               i_section,             &
                                               i_part,                &
                                               n_elts,                &
                                               c_connec,              &
  ...
  end subroutine PDM_part_mesh_nodal_section_std_set


  subroutine PDM_part_mesh_nodal_cells_cellvtx_add(mesh,         &
                                                   id_part,      &
                                                   n_cell,       &
                                                   cell_vtx_idx, &
                                                   cell_vtx,     &
    ...
    interface
      subroutine PDM_part_mesh_nodal_cells_cellvtx_add_c(mesh,         &
                                                         id_part,      &
                                                         n_cell,       &
                                                         cell_vtx_idx, &
                                                         cell_vtx,     &
                                                         numabs,       &
                                                         owner)        &
        bind(c, name='PDM_part_mesh_nodal_cells_cellvtx_add')
        use iso_c_binding
        implicit none
        type(c_ptr),     value :: mesh
        integer (c_int), value :: id_part
    ...
    call PDM_part_mesh_nodal_cells_cellvtx_add_c(mesh,           &
                                                 id_part,        &
                                                 n_cell,         &
                                                 c_cell_vtx_idx, &
                                                 c_cell_vtx,     &
  ...
  subroutine PDM_part_mesh_nodal_faces_facevtx_add(mesh,         &
                                                   id_part,      &
                                                   n_face,       &
                                                   face_vtx_idx, &
                                                   face_vtx,     &
    ...
    interface
      subroutine PDM_part_mesh_nodal_faces_facevtx_add_c(mesh,         &
                                                         id_part,      &
                                                         n_face,       &
                                                         face_vtx_idx, &
                                                         face_vtx,     &
                                                         numabs,       &
                                                         owner)        &
        bind(c, name='PDM_part_mesh_nodal_faces_facevtx_add')
        use iso_c_binding
        implicit none
        type(c_ptr),     value :: mesh
        integer (c_int), value :: id_part
    ...
    call PDM_part_mesh_nodal_faces_facevtx_add_c(mesh,           &
                                                 id_part,        &
                                                 n_face,         &
                                                 c_face_vtx_idx, &
                                                 c_face_vtx,     &
  ...
  subroutine PDM_part_mesh_nodal_face2d_faceedge_add(mesh,          &
                                                     id_part,       &
                                                     n_elt,         &
                                                     n_edge,        &
                                                     edge_vtx,      &
    ...
    interface
      subroutine PDM_part_mesh_nodal_face2d_faceedge_add_c(mesh,          &
                                                           id_part,       &
                                                           n_elt,         &
                                                           n_edge,        &
                                                           edge_vtx,      &
    ...
    call PDM_part_mesh_nodal_face2d_faceedge_add_c(mesh,            &
                                                   id_part,         &
                                                   n_elt,           &
                                                   n_edge,          &
                                                   c_edge_vtx,      &
  ...
  subroutine PDM_part_mesh_nodal_cell3d_cellface_add(mesh,          &
                                                     id_part,       &
                                                     n_elt,         &
                                                     n_face,        &
                                                     face_vtx_idx,  &
    ...
    integer (pdm_l_num_s), pointer :: face_vtx_idx(:)  ! Index of face->vertex connectivity
    integer (pdm_l_num_s), pointer :: face_vtx(:)      ! Face->vertex connectivity
    integer (pdm_g_num_s), pointer :: face_ln_to_gn(:) ! Face global IDs
    ...
    interface
      subroutine PDM_part_mesh_nodal_cell3d_cellface_add_c(mesh,          &
                                                           id_part,       &
                                                           n_elt,         &
                                                           n_face,        &
                                                           face_vtx_idx,  &
    ...
    call PDM_part_mesh_nodal_cell3d_cellface_add_c(mesh,            &
                                                   id_part,         &
                                                   n_elt,           &
                                                   n_face,          &
                                                   c_face_vtx_idx,  &
  ...
  function PDM_part_mesh_nodal_n_section_in_geom_kind_get(pmn,       &
    ...
    n_section = PDM_part_mesh_nodal_n_section_in_geom_kind_get_c(pmn, &
                                                                 geom_kind)
  ...
  subroutine PDM_part_mesh_nodal_sections_id_in_geom_kind_get(pmn,       &
    ...
    interface
      function PDM_part_mesh_nodal_sections_id_in_geom_kind_get_c(pmn, geom_kind) result(sections_id) &
      ...
      end function PDM_part_mesh_nodal_sections_id_in_geom_kind_get_c
    end interface

    n_section = PDM_part_mesh_nodal_n_section_in_geom_kind_get_c(pmn, &
                                                                 geom_kind)

    c_sections_id = PDM_part_mesh_nodal_sections_id_in_geom_kind_get_c(pmn, &
                                                                       geom_kind)
  ...
  subroutine PDM_part_mesh_nodal_section_in_geom_kind_elt_type_get(pmn,        &
    ...
    interface
      function PDM_part_mesh_nodal_section_in_geom_kind_elt_type_get_c(pmn, geom_kind, id_section) result(elt_type) &
      ...
      end function PDM_part_mesh_nodal_section_in_geom_kind_elt_type_get_c
    end interface

    elt_type = PDM_part_mesh_nodal_section_in_geom_kind_elt_type_get_c(pmn,       &
                                                                       geom_kind, &
                                                                       id_section)
  ...
  subroutine PDM_part_mesh_nodal_section_n_elt_get(pmn,       &
    ...
    n_elt = PDM_part_mesh_nodal_section_n_elt_get_c(pmn,       &
                                                    i_section, &
                                                    i_part)
  ...
  subroutine PDM_part_mesh_nodal_section_elt_type_get(pmn,       &
    ...
    elt_t = PDM_part_mesh_nodal_section_elt_type_get_c(pmn, &
                                                       i_section)
  ...
  subroutine PDM_part_mesh_nodal_section_std_get(pmn,                 &
    ...
    interface
      subroutine PDM_part_mesh_nodal_section_std_get_c(pmn,                 &
                                                       i_section,           &
                                                       i_part,              &
                                                       connec,              &
                                                       numabs,              &
      ...
      integer(c_int), value :: ownership
      type (c_ptr)          :: numabs
      type (c_ptr)          :: parent_entity_g_num
      type (c_ptr)          :: connec
      type (c_ptr)          :: parent_num
      end subroutine PDM_part_mesh_nodal_section_std_get_c
    end interface
    ...
    c_parent_entity_g_num = C_NULL_PTR
    c_parent_num          = C_NULL_PTR
    call PDM_part_mesh_nodal_section_std_get_c(pmn,                   &
                                               i_section,             &
                                               i_part,                &
                                               c_connec,              &
                                               c_numabs,              &
  ...
  subroutine PDM_part_mesh_nodal_n_elmts_get(pmn,       &
    ...
    n_elmts = PDM_part_mesh_nodal_n_elmts_get_c(pmn,       &
                                                geom_kind, &
                                                i_part)
  ...
  subroutine PDM_part_mesh_nodal_cell_vtx_connect_get(mesh,         &
    ...
    c_cell_vtx_idx = C_NULL_PTR
    c_cell_vtx     = C_NULL_PTR
    call PDM_part_mesh_nodal_cell_vtx_connect_get_c(mesh,           &
                                                    geom_kind,      &
                                                    id_part,        &
                                                    c_cell_vtx_idx, &
                                                    c_cell_vtx)
  ...
  subroutine PDM_part_mesh_nodal_n_vtx_get(pmn,    &
    ...
    n_vtx = PDM_part_mesh_nodal_n_vtx_get_c(pmn, &
                                            i_part)
  ...
  subroutine PDM_part_mesh_nodal_vtx_coord_get(pmn,       &
    ...
    interface
      function PDM_part_mesh_nodal_vtx_coord_get_c(pmn, i_part, ownership) result(vtx_coord) &
      ...
      end function PDM_part_mesh_nodal_vtx_coord_get_c
    end interface
    ...
    c_vtx_coord = PDM_part_mesh_nodal_vtx_coord_get_c(pmn,         &
                                                      i_part,      &
                                                      c_ownership)
  ...
  subroutine PDM_part_mesh_nodal_vtx_g_num_get(pmn,          &
    ...
    interface
      function PDM_part_mesh_nodal_vtx_g_num_get_c(pmn, i_part, ownership) result(vtx_ln_to_gn) &
      ...
      end function PDM_part_mesh_nodal_vtx_g_num_get_c
    end interface
    ...
    c_vtx_ln_to_gn = PDM_part_mesh_nodal_vtx_g_num_get_c(pmn,    &
                                                         i_part, &
                                                         c_ownership)
