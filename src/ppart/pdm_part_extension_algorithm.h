...
(
  ...
  PDM_g_num_t                ***pentity2_extented_alrdy_sent_out,
  int                        ***pentity2_extented_ancstr_idx_out,
  PDM_g_num_t                ***pentity2_extented_from_interf_out,
  PDM_g_num_t                ***pentity2_extented_parent_out,
