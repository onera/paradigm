 ...
 )
{
  ...
  if (i_rank == 0) {
    ...
    while (1) {
      ...
      if (strstr(line, "Dimension") != NULL) {
        ...
        gvtx_group = malloc(sizeof(int   ) * gn_vtx);
    ...
    if (1) {
      /* Shift groups */
      _shift_groups((int) gn_vtx,   gvtx_group);
  ...
  if (gvtx_group   != NULL) free(gvtx_group);
  ...
  /* Groups */
  PDM_DMesh_nodal_vtx_tag_set(dmn, dvtx_group);
