...
MPI_TEST_CASE("[1p] dcube_nodal_gen HEXA ",1) {
  ...
  std::vector<PDM_Mesh_nodal_elt_t> section_types_expexted = {PDM_MESH_NODAL_HEXA8, PDM_MESH_NODAL_QUAD4, PDM_MESH_NODAL_QUAD4,
  ...
  for(int i_section = 0; i_section < n_section; ++i_section) {
    ...
    CHECK( section_types_expexted[i_section] == t_elmt);
...
MPI_TEST_CASE("[1p] dcube_nodal_gen PRISM ",1) {
  ...
  std::vector<PDM_Mesh_nodal_elt_t> section_types_expexted = {PDM_MESH_NODAL_PRISM6, PDM_MESH_NODAL_QUAD4, PDM_MESH_NODAL_QUAD4,
                                                              PDM_MESH_NODAL_QUAD4, PDM_MESH_NODAL_QUAD4,
  ...
  CHECK( n_section == 7); // PRISM + 4 * QUAD + 2 * TRI
...
MPI_TEST_CASE("[1p] dcube_nodal_gen TETRA ",1) {
  ...
  std::vector<PDM_Mesh_nodal_elt_t> section_types_expexted = {PDM_MESH_NODAL_TETRA4, PDM_MESH_NODAL_TRIA3, PDM_MESH_NODAL_TRIA3,
                                                              PDM_MESH_NODAL_TRIA3, PDM_MESH_NODAL_TRIA3,
                                                              PDM_MESH_NODAL_TRIA3, PDM_MESH_NODAL_TRIA3};
...
MPI_TEST_CASE("[1p] dcube_nodal_gen QUAD ",1) {
  ...
  std::vector<PDM_Mesh_nodal_elt_t> section_types_expexted = {PDM_MESH_NODAL_QUAD4, PDM_MESH_NODAL_BAR2, PDM_MESH_NODAL_BAR2,
...
MPI_TEST_CASE("[1p] dcube_nodal_gen TRI ",1) {
  ...
  std::vector<PDM_Mesh_nodal_elt_t> section_types_expexted = {PDM_MESH_NODAL_TRIA3, PDM_MESH_NODAL_BAR2, PDM_MESH_NODAL_BAR2,
                                                              PDM_MESH_NODAL_BAR2, PDM_MESH_NODAL_BAR2};
