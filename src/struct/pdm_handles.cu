...
// {
//   PDM_Handles_t *nouv;
//   cudaMalloc (&nouv, sizeof(PDM_Handles_t));

//   nouv->s_array = init_size;
//   nouv->n_handles = 0;
//   nouv->array = cudaMalloc(sizeof(void*) * init_size);
//   nouv->idx = cudaMalloc(sizeof(int) * init_size);
//   nouv->idx_inv = cudaMalloc(sizeof(int) * init_size);
