...
module pdm_isosurface
  ...
  subroutine PDM_isosurface_n_part_set(isos, &
    ...
    interface
      subroutine PDM_isosurface_n_part_set_cf(isos,   &
                                              n_part) &
      ...
      end subroutine PDM_isosurface_n_part_set_cf
    end interface

    call PDM_isosurface_n_part_set_cf(isos,   &
                                      n_part)
  ...
  subroutine PDM_isosurface_n_group_set(isos, &
    ...
    integer, intent(in) :: n_group     ! Number of group

    interface
      subroutine PDM_isosurface_n_group_set_cf (isos,        &
                                                entity_type, &
                                                n_group)     &
      ...
      end subroutine PDM_isosurface_n_group_set_cf
    end interface

    call PDM_isosurface_n_group_set_cf(isos, &
                                       entity_type, &
                                       n_group)
  ...
  subroutine PDM_isosurface_part_mesh_set(isos, & 
    ...
    type(c_ptr) :: isos  ! PDM_isosurface_t instance
    type(c_ptr) :: pmesh ! PDM_part_mesh_t instance

    interface
      subroutine PDM_isosurface_part_mesh_set_cf (isos,  &
                                                  pmesh) &
      bind(c, name = 'PDM_isosurface_part_mesh_set')
        ...
        type(c_ptr), value :: isos
        type(c_ptr), value :: pmesh

      end subroutine PDM_isosurface_part_mesh_set_cf
    end interface

    call PDM_isosurface_part_mesh_set_cf (isos,  &
                                          pmesh)
  ...
  subroutine PDM_isosurface_part_mesh_nodal_set (isos, &
    ...
    type(c_ptr) :: isos ! PDM_isosurface_t instance
    type(c_ptr) :: pmn  ! PDM_part_mesh_nodal_t instance

    interface
      subroutine PDM_isosurface_part_mesh_nodal_set_cf (isos, &
                                                        pmn)  &
      ...
      end subroutine PDM_isosurface_part_mesh_nodal_set_cf
    end interface

    call PDM_isosurface_part_mesh_nodal_set_cf (isos, &
                                                pmn)
  ...
  subroutine PDM_isosurface_dmesh_set (isos,  &
    ...
    type(c_ptr) :: isos  ! PDM_isosurface_t instance
    type(c_ptr) :: dmesh ! PDM_dmesh_t instance

    interface
      subroutine PDM_isosurface_dmesh_set_cf (isos,  &
                                              dmesh) &
      ...
      end subroutine PDM_isosurface_dmesh_set_cf
    end interface

    call PDM_isosurface_dmesh_set_cf (isos,  &
                                      dmesh)
  ...
  subroutine PDM_isosurface_dmesh_nodal_set (isos, &
    ...
    type(c_ptr) :: isos ! PDM_isosurface_t instance
    type(c_ptr) :: dmn  ! PDM_dmesh_nodal_t instance

    interface
      subroutine PDM_isosurface_dmesh_nodal_set_cf (isos, &
                                                    dmn)  &
      ...
      end subroutine PDM_isosurface_dmesh_nodal_set_cf
    end interface

    call PDM_isosurface_dmesh_nodal_set_cf (isos, &
                                            dmn)
  ...
  subroutine PDM_isosurface_redistribution_set (isos,         &
    ...
    type(c_ptr) :: isos                 ! PDM_isosurface_t instance
    integer, intent(in) :: extract_kind ! Redistribution kind
    integer, intent(in) :: part_method  ! Partitioning method (only used if ``extract_kind`` is set to PDM_EXTRACT_PART_KIND_REEQUILIBRATE)

    interface
      subroutine PDM_isosurface_redistribution_set_cf (isos,         &
                                                       extract_kind, &
                                                       part_method)  &
      ...
      end subroutine PDM_isosurface_redistribution_set_cf
    end interface

    call PDM_isosurface_redistribution_set_cf (isos,         &
                                               extract_kind, &
                                               part_method)
  ...
  subroutine PDM_isosurface_reset (isos,          &
    ...
    type(c_ptr)         :: isos          ! PDM_isosurface_t instance
    integer, intent(in) :: id_isosurface ! Iso-surface identifier (if <0, reset all iso-surfaces)

    interface
      subroutine PDM_isosurface_reset_cf (isos,          &
                                          id_isosurface) &
      ...
      end subroutine PDM_isosurface_reset_cf
    end interface

    call PDM_isosurface_reset_cf (isos,          &
                                  id_isosurface)
  ...
  subroutine PDM_isosurface_n_part_out_set (isos,       &
    ...
    type(c_ptr)         :: isos       ! PDM_isosurface_t instance
    integer, intent(in) :: n_part_out ! Number of partitions

    interface
      subroutine PDM_isosurface_n_part_out_set_cf (isos,       &
                                                   n_part_out) &
      ...
      end subroutine PDM_isosurface_n_part_out_set_cf
    end interface

    call PDM_isosurface_n_part_out_set_cf (isos,       &
                                           n_part_out)
  ...
  subroutine PDM_isosurface_compute (isos,          &
    ...
    type(c_ptr)         :: isos          ! PDM_isosurface_t instance
    integer, intent(in) :: id_isosurface ! Iso-surface identifier (if < 0, compute all iso-surfaces)

    interface
      subroutine PDM_isosurface_compute_cf (isos,          &
                                            id_isosurface) &
      ...
      end subroutine PDM_isosurface_compute_cf
    end interface

    call PDM_isosurface_compute_cf (isos,          &
                                    id_isosurface)
  ...
  subroutine PDM_isosurface_dump_times (isos)
    ...
    interface
      subroutine PDM_isosurface_dump_times_cf (isos) &
      ...
      end subroutine PDM_isosurface_dump_times_cf
    end interface

    call PDM_isosurface_dump_times_cf (isos)
  ...
  subroutine PDM_isosurface_part_to_part_enable (isos,              &
    ...
    integer, intent(in) :: unify_parent_info ! Get all parent over all procs (not implemented)

    interface
      subroutine PDM_isosurface_part_to_part_enable_cf (isos,              &
                                                        id_isosurface,     &
                                                        entity_type,       &
                                                        unify_parent_info) &
      ...
      end subroutine PDM_isosurface_part_to_part_enable_cf
    end interface

    call PDM_isosurface_part_to_part_enable_cf (isos,              &
                                                id_isosurface,     &
                                                entity_type,       &
                                                unify_parent_info)
  ...
  subroutine PDM_isosurface_part_to_part_get (isos,          &
    ...
    integer,     intent(in)  :: ownership     ! Ownership for ``ptp``

    interface
      subroutine PDM_isosurface_part_to_part_get_cf (isos,          &
                                                     id_isosurface, &
                                                     entity_type,   &
                                                     ptp,           &
                                                     ownership)     &
      ...
      end subroutine PDM_isosurface_part_to_part_get_cf
    end interface

    call PDM_isosurface_part_to_part_get_cf (isos,          &
                                             id_isosurface, &
                                             entity_type,   &
                                             ptp,           &
                                             ownership)
  ...
  subroutine PDM_isosurface_free (isos)
    ...
    interface
      subroutine PDM_isosurface_free_cf (isos)&
      ...
      end subroutine PDM_isosurface_free_cf
    end interface

    call PDM_isosurface_free_cf (isos)
  ...
  subroutine PDM_isosurface_pconnectivity_set (isos,              &
    ...
    integer(kind=pdm_l_num_s), pointer, intent(in) :: connect_idx(:)    ! Index for connectivity
    integer(kind=pdm_l_num_s), pointer, intent(in) :: connect(:)        ! Connectivity
  ...
  subroutine PDM_isosurface_pvtx_coord_set(isos,   &
    ...
    real(8), pointer, intent(in) :: vtx_coord(:,:) ! Vertex coordinates (shape = [3, *n_vtx*])
  ...
  subroutine PDM_isosurface_ln_to_gn_set(isos,        &
    ...
    integer,                            intent(in) :: i_part         ! Partition identifier
    integer,                            intent(in) :: entity_type    ! Type of mesh entity
    integer(kind=pdm_g_num_s), pointer, intent(in) :: ln_to_gn(:)    ! Global Ids
  ...
  subroutine PDM_isosurface_pgroup_set(isos,             &
    ...
    integer,                            intent(in) :: i_part                   ! Partition identifier
    integer,                            intent(in) :: entity_type              ! Type of mesh entity
    integer(kind=pdm_l_num_s), pointer, intent(in) :: group_entity_idx(:)      ! Index for group->entity connectivity (size = ``n_group`` + 1)
    integer(kind=pdm_l_num_s), pointer, intent(in) :: group_entity(:)          ! Group->entity connectivity (size = ``group_entity_idx``[``n_group``])
    integer(kind=pdm_g_num_s), pointer, intent(in) :: group_entity_ln_to_gn(:) ! Group->entity connectivity (group-specific global ids, size = ``group_entity_idx``[``n_group``])
  ...
  subroutine PDM_isosurface_dconnectivity_set(isos,              &
    ...
    type(c_ptr),                        intent(in) :: isos              ! PDM_isosurface_t instance
    integer,                            intent(in) :: connectivity_type ! Type of connectivity
    integer(kind=pdm_l_num_s), pointer, intent(in) :: dconnect_idx(:)   ! Index for connectivity
    integer(kind=pdm_g_num_s), pointer, intent(in) :: dconnect(:)       ! Connectivity
  ...
  subroutine PDM_isosurface_dvtx_coord_set(isos, &
    ...
    type(c_ptr),      intent(in) :: isos            ! PDM_isosurface_t instance
    real(8), pointer, intent(in) :: dvtx_coord(:,:) ! Vertices coordinates (shape = [3, *n_vtx*])
  ...
  subroutine PDM_isosurface_distrib_set(isos,        &
    ...
    type(c_ptr),                        intent(in) :: isos        ! PDM_isosurface_t instance
    integer,                            intent(in) :: entity_type ! Type of mesh entity
    integer(kind=pdm_g_num_s), pointer, intent(in) :: distrib(:)  ! Block-distribution (size = *n_rank* + 1)
  ...
  subroutine PDM_isosurface_dgroup_set(isos,              &
    ...
    type(c_ptr),                        intent(in) :: isos                 ! PDM_isosurface_t instance
    integer,                            intent(in) :: entity_type          ! Type of mesh entity
    integer(kind=pdm_l_num_s), pointer, intent(in) :: dgroup_entity_idx(:) ! Index for group->entity connectivity (size = ``n_group`` + 1)
    integer(kind=pdm_g_num_s), pointer, intent(in) :: dgroup_entity(:)     ! Group->entity connectivity (size = ``dgroup_entity_idx(n_group+1)``)
  ...
  subroutine PDM_isosurface_add (isos,        &
    ...
    real(8), pointer, intent(in)  :: isovalues(:)   ! Iso-values to capture (size = ``n_isovalues``)
  ...
  subroutine PDM_isosurface_isovalues_set (isos,          &
                                          id_isosurface, &
                                          n_isovalues,   &
                                          isovalues)
  ...
  subroutine PDM_isosurface_equation_set (isos,          &
    ...
    type(c_ptr),      intent(in) :: isos          ! PDM_isosurface_t instance
    integer,          intent(in) :: id_isosurface ! Iso-surface identifier
    real(8), pointer, intent(in) :: coeff(:)      ! Equation coefficients refer to the :ref:`note below <PDM_iso_surface_kind_t>` to know how many coefficients are needed for each PDM_iso_surface_kind_t
  ...
  subroutine PDM_isosurface_pfield_set (isos,          &
    ...
    integer,          intent(in) :: id_isosurface ! Iso-surface identifier
    integer,          intent(in) :: i_part        ! Partition identifier
    real(8), pointer, intent(in) :: field(:)      ! Field values (size = *n_vtx*)
  ...
  subroutine PDM_isosurface_dfield_set (isos,          &
    ...
    type(c_ptr),      intent(in) :: isos          ! PDM_isosurface_t instance
    integer,          intent(in) :: id_isosurface ! Iso-surface identifier
    real(8), pointer, intent(in) :: dfield(:)     ! Field values (size = *dn_vtx*)
  ...
  subroutine PDM_isosurface_set_tolerance(isos, &
    ...
    real(8), intent(in) :: tol  ! Field tolerance (default at 0)
  ...
  subroutine PDM_isosurface_pvtx_coord_get (isos,          &
                                            id_isosurface, &
                                            i_part,        &
                                            n_vtx,         &
                                            vtx_coord,     &
  ...
  subroutine PDM_isosurface_ln_to_gn_get (isos,          &
                                          id_isosurface, &
                                          i_part,        &
                                          entity_type,   &
                                          n_entity,      &
  ...
  subroutine PDM_isosurface_pgroup_get (isos,                  &
                                        id_isosurface,         &
                                        i_part,                &
                                        entity_type,           &
                                        n_group,               &
  ...
  end subroutine PDM_isosurface_dconnectivity_get


  subroutine PDM_isosurface_dparent_weight_get (isos,           &
                                                id_isosurface,  &
                                                entity_type,    &
                                                n_iso_entity,   &
                                                dparent_idx,    &
  ...
  end subroutine PDM_isosurface_dparent_weight_get

  subroutine PDM_isosurface_dvtx_coord_get (isos,          &
                                            id_isosurface, &
                                            dn_vtx,        &
                                            dvtx_coord,    &
                                            ownership)
  ...
  end subroutine PDM_isosurface_dgroup_get


  subroutine PDM_isosurface_pisovalue_entity_idx_get (isos,                &
                                                      id_isosurface,       &
                                                      i_part,              &
                                                      entity_type,         &
                                                      n_isovalues,         &
  ...
  end subroutine PDM_isosurface_pisovalue_entity_idx_get


  subroutine PDM_isosurface_disovalue_entity_get (isos,                 &
                                                  id_isosurface,        &
                                                  entity_type,          &
                                                  n_isovalues,          &
  ...
  end subroutine PDM_isosurface_disovalue_entity_get


  subroutine PDM_isosurface_plocal_parent_get (isos,              &
                                               id_isosurface,     &
                                               i_part,            &
                                               entity_type,       &
                                               n_entity,          &
    ...
    integer, intent(in)                :: entity_type          ! Type of mesh entity
    integer                            :: n_entity             ! Number of entities
    integer(kind=pdm_l_num_s), pointer :: entity_parent_idx(:) ! Index for isosurface entity->parent connectivity (size = ``n_entity`` + 1)
    integer(kind=pdm_l_num_s), pointer :: entity_parent(:)     ! Isosurface entity->parent connectivity (size = ``entity_parent_idx``[``n_entity``])
    integer, intent(in)                :: ownership            ! Ownership
  ...
  end subroutine PDM_isosurface_plocal_parent_get


  subroutine PDM_isosurface_pparent_weight_get (isos,          &
                                                id_isosurface, &
                                                i_part,        &
                                                entity_type,   &
                                                n_iso_entity,  &
  ...
  end subroutine PDM_isosurface_pparent_weight_get
