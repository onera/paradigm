...
int main(int argc, char *argv[])
{
  ...
  const int      nFace = 42;
  const int      nVtx  = 36; 
  double   coords[108] = {0.,  0.,  0.,  2.,  0.,  0.,  4.,  0.,  0.,  6.,  0.,  0.,
  ...
  int  cellFace[52] = { 1,  2,  6,  7,  9, 10, 12, 15, 21, 24,
                        26, 27, 29, 35, 36, 37, 40, 41,  4,  5,
                        10, 11, 15, 16, 17, 18, 19, 20, 25, 28,
                        32, 33, 34, 35, 36, 42,  2,  3,  7,  8,
                        13, 14, 16, 17, 22, 23, 24, 25, 30, 31,
                        38, 39};
