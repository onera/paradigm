...
static void _run_test_2d_ngon(PDM_isosurface_test_utils_params_t params);
...
)
{
  ...
  if (argc <= 1) {
    ...
    params.n_vtx_seg = 10;
    params.randomize = 0;
    params.elt_type  = PDM_MESH_NODAL_QUAD4;
    params.visu      = 0;
...
)
{
  ...
  PDM_isosurface_test_utils_isosurface_params_dump(comm, "pdm_t_isosurface_2d_ngon", params);
