...
elseif(PTSCOTCH_DIR)
    set(_PTSCOTCH_ROOT "${PTSCOTCH_DIR}")
elseif(DEFINED ENV{PTSCOTCH_DIR})
    set(_PTSCOTCH_ROOT "$ENV{PTSCOTCH_DIR}")
elseif(DEFINED ENV{PTSCOTCH_ROOT})
    set(_PTSCOTCH_ROOT "$ENV{PTSCOTCH_ROOT}")
elseif(DEFINED ENV{SCOTCH_DIR})
    set(_PTSCOTCH_ROOT "$ENV{SCOTCH_DIR}")
elseif(DEFINED ENV{SCOTCH_ROOT})
    set(_PTSCOTCH_ROOT "$ENV{SCOTCH_ROOT}")
endif()
